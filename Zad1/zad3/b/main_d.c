...
int main(int argc,char* argv[])
{
    ...
    struct Blocks (*lib_fun)();
    int current_time = 0;
    if(strstr(argv[3],"d") != NULL){
        time[current_time] = times(tms[current_time]);
	lib_fun = (struct Blocks (*)())dlsym(handle,"createDynamicBlock");
        current_time += 1;
        blocks = (*lib_fun)(tableSize,blockSize);
        ...
        time[current_time] = times(tms[current_time]);
	lib_fun = (struct Blocks (*)())dlsym(handle,"createStaticBlock");
        current_time += 1;
        blocks = (*lib_fun)(tableSize,blockSize);
    ...
    int table,action;
    char*tablex;
    char* (*find)() = (char* (*)())dlsym(handle,"findCloseBlock");
    void (*deleteBlock)() = (void (*)())dlsym(handle,"deleteBlock");
    void (*deleteBlockStatic)() = (void (*)())dlsym(handle,"deleteBlockStatic");
    void (*addToBlock)() = (void (*)())dlsym(handle,"addToBlock");
    void (*deleteTable)() = (void (*)())dlsym(handle,"deleteTable");
